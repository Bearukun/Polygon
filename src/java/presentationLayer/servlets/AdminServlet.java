...
//                    String assignedTechEmail = userList.get(technicianId).getEmail();
                ...
                case "sendEmailToAllUsers":
                    ...
                    //To make sure there isen't any holes or null pointers in the Arraylist,
                    // we populate a new arraylist to clear/remove any holes.
                    ArrayList<User> temp = usrCtrl.getUsers();

                    //Retrives data to be send in the email

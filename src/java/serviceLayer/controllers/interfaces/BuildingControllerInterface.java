...
public interface BuildingControllerInterface {
    ...
    void createBuilding( String name, String address, Integer postcode, String city,  Integer construction_year, String purpose, Integer sqm,int assigned_tech_id, int user_id) throws CustomException;
